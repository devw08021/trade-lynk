        ...
        >
            <div className="space-y-6">
                <div className="card-dark">
                    <div className="flex-between mb-4">
                        <div className="font-medium text-white">
                            {selectedCoin?.coin} Deposit Address
                        </div>
                ...
                <div className="alert-warning">
                    <p className="text-sm">
                        <strong>Important:</strong> Only send {selectedCoin?.coin} to this address on the {selectedCoin?.coin} network.
                ...
                <div className="card-dark">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex-between">
                            ...
                            <span className="text-white">0.001 {selectedCoin?.coin}</span>
                        </div>
                        <div className="flex-between">
                            <span className="text-gradient-secondary">Confirmations Required:</span>
                            <span className="text-white">{selectedCoin?.coin === 'BTC' ? '3' : selectedCoin?.coin === 'ETH' ? '12' : '6'}</span>
                        </div>
                        <div className="flex-between">
