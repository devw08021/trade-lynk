...
export default function PerpetualTradingView({ symbol }: PerpetualTradingViewProps) {
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex justify-between items-center mb-4 px-2">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{symbol} Perpetual Chart</h2>
      ...
      <div className="flex-grow w-full bg-gray-50 dark:bg-dark-300 rounded-md flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-500 dark:text-gray-400">Perpetual Chart Placeholder</p>
